...
import AddAndUpdateUser from '@/containers/customerScreens/userManagment/addandUpdateUser';
import UserProfile from '@/containers/customerScreens/userManagment/userProfile';
import UserListing from '@/containers/customerScreens/userManagment/userListing';
import AgentHome from '@/containers/agentScreens/main/agentHome';
import ScheduleViewing from '@/containers/agentScreens/leads/scheduleAViewing';
import LatestActivities from '@/containers/agentScreens/leads/latestActivities';
import AllLeads from '@/containers/agentScreens/leads/allLeads';
import Login from '@/containers/auth/login';
import dataHandlerService from '@/services/mainServices/dataHandler.service';
import DashBoardCustomer from '@/containers/customerScreens/Main/dashboardCustomer';
import CustomerPropertyPortfolio from '@/containers/customerScreens/portfolio/potfolio';
import PortfolioDetail from '@/containers/customerScreens/portfolio/portfolioDetail';
import ConstructionUpdateList from '@/containers/customerScreens/constructionUpdates/constructionUpdateListing';
import ConstructionUpdateDetail from '@/containers/customerScreens/constructionUpdates/constructionUpdateDetail';
import Signup from '@/containers/auth/signup';
import Otp from '@/containers/auth/otp';
import NoteLogs from '@/containers/agentScreens/logs/noteLogs';
import CallLogs from '@/containers/agentScreens/logs/callLogs';
import EventLogs from '@/containers/agentScreens/logs/eventLogs';
import TaskLogs from '@/containers/agentScreens/logs/taskLogs';
import SingleLeadDetails from '@/containers/agentScreens/leads/singleLeadDetails';
import Financials from '@/containers/customerScreens/invoiceAndPayment/financials';
import InvoiceViewer from '@/containers/customerScreens/invoiceAndPayment/invoice';
import PaymentPlan from '@/containers/customerScreens/invoiceAndPayment/paymentPlan';
import ActivityDetails from '@/containers/agentScreens/leads/activitiesDetail';
import DeleteAccount from '@/containers/sideScreens/deleteAccount';
import PaymentScreen from '@/containers/customerScreens/invoiceAndPayment/paymentScreen';
import {postLogOutVerifyApi} from '@/services/apiMethods/authApis';
import {AxiosError} from 'axios';
import ImageWork from '@/containers/agentScreens/main/imageWork';
...
const MainTabsCustomer = props => {
  ...
  const onPressLogOut = async () => {
    ...
    try {
      ...
      const responseLogOut = await postLogOutVerifyApi(payLoad);
...
const MainTabsAgent = props => {
  ...
  const onPressLogOut = async () => {
    try {
      ...
      const err = error as AxiosError;
      console.log('errresponse', err?.response?.data?.message);
      Alert.alert(err?.response?.data?.message);
    }
  };
  return (
